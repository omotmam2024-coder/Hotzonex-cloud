...
export function createFixtures() {
  ...
  const routers: Row[] = [
    ...
    // Added on the local network and reachable there, but not yet on a tunnel:
    // the state the wizard offers remote access in.
    { ...baseRouter, id: 'r-5', name: 'Munuki Clinic', location_id: null, host: '192.168.88.1', wg_address: '10.77.0.9', wg_public_key: null, wg_last_handshake_at: null, status: 'online', last_seen_at: iso(30_000), identity: 'HZX-CLINIC-1', board_name: 'hAP ax lite', routeros_version: '7.19.4', uptime_seconds: 3_600, cpu_load: 5, onboarding_completed_at: null, discovered_at: null, hotspot_server_id: null, default_hotspot_profile_id: null },
